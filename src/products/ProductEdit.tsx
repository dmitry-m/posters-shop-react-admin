...
const ProductTitle = () => {
  ...
  return record ? <span>Poster &ldquo;{record.reference}&rdquo;</span> : null;
};

const ProductEdit = () => (
  <Edit title={<ProductTitle />}>
    <TabbedForm>
      <TabbedForm.Tab label="resources.products.tabs.image" sx={{ maxWidth: "40em" }}>
        <Poster />
      ...
      <TabbedForm.Tab
        ...
        path="reviews"
      >
        <ReferenceManyField reference="reviews" target="product_id" pagination={<Pagination />}>
          <Datagrid
            sx={{
              width: "100%",
              "& .column-comment": {
